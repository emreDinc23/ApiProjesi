        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortföyNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PortföyCoverImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portföys", x => x.PortföyID);
                });
